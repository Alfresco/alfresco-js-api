        ...
        describe('With Authentication', () => {
            ...
            describe('isLoggedIn', () => {
                it('should return true if the api is logged in', (done) => {
                    ...
                    alfrescoJsApi.login('admin', 'admin').then(() => {
                        expect(alfrescoJsApi.isLoggedIn()).toEqual(true);
                        done();
                    });
                });
                ...
                it('should return false if the api is logged out', (done) => {
                    ...
                    alfrescoJsApi.logout().then(() => {
                        expect(alfrescoJsApi.isLoggedIn()).toEqual(false);
                        done();
                    });
                });
            });
            ...
            describe('With Ticket Authentication', () => {
                it('should Ticket be present in the client', () => {
                    ...
                    expect('TICKET_4479f4d3bb155195879bfbb8d5206f433488a1b1').toEqual(alfrescoJsApi.contentClient.authentications.basicAuth.password);
                });
                ...
                it('should Ticket login be validate against the server if is valid', (done) => {
                    ...
                    alfrescoJsApi.loginTicket(ticket, null).then((data: string) => {
                        expect(alfrescoJsApi.contentAuth.authentications.basicAuth.password).toEqual(ticket);
            ...
            describe('Logout Api', () => {
                ...
                it('should Ticket be absent in the client and the resolve promise should be called', (done) => {
                    ...
                    alfrescoJsApi.logout().then((data: string) => {
                        expect(alfrescoJsApi.config.ticket).toEqual(undefined);
                ...
                it('should Logout be rejected if the Ticket is already expired', (done) => {
                    ...
                    alfrescoJsApi.logout().then(NOOP, (error: any) => {
                        expect(error.error.toString()).toEqual('Error: Not Found');
                        done();
                    });
                });
            });
            ...
            describe('Unauthorized', () => {
                ...
                it('should 401 invalidate the ticket', (done) => {
                    ...
                    alfrescoJsApi.nodes.createFolder('newFolder', null, null).then(NOOP, () => {
                        expect(alfrescoJsApi.contentAuth.authentications.basicAuth.password).toEqual(null);
                        done();
                    });
                });
        ...
        describe('With Authentication', () => {
            describe('login', () => {
                it('should return the Ticket if all is ok', (done) => {
                    ...
                    alfrescoJsApi.login('admin', 'admin').then(
                        (data: string) => {
                            expect(data).toEqual('Basic YWRtaW46YWRtaW4=');
                            done();
                        },
                        (error: any) => {
            ...
            describe('Unauthorized', () => {
                ...
                it('should 401 invalidate the ticket', (done) => {
                    ...
                    alfrescoJsApi.activiti.profileApi.getProfile().then(NOOP, () => {
                        expect(alfrescoJsApi.processAuth.authentications.basicAuth.ticket).toEqual(null);
                        done();
                    });
                });
                ...
                it('should 401 invalidate the session and logout', (done) => {
                    ...
                    alfrescoJsApi.activiti.profileApi.getProfile().then(
                        () => NOOP,
                        () => {
                            expect(alfrescoJsApi.isLoggedIn()).toEqual(false);
                            done();
    ...
    describe('BPM and ECM Provider config', () => {
        ...
        describe('With Authentication', () => {
            it('should Ticket be present in the client', () => {
                ...
                expect('Basic YWRtaW46YWRtaW4=').toEqual(alfrescoJsApi.processClient.authentications.basicAuth.ticket);
                expect('TICKET_4479f4d3bb155195879bfbb8d5206f433488a1b1').toEqual(alfrescoJsApi.contentClient.authentications.basicAuth.password);
            });
            ...
            describe('login', () => {
                it('should return the Ticket if all is ok', (done) => {
                    ...
                    alfrescoJsApi.login('admin', 'admin').then((data: string[]) => {
                        expect(data[0]).toEqual('TICKET_4479f4d3bb155195879bfbb8d5206f433488a1b1');
                        expect(data[1]).toEqual('Basic YWRtaW46YWRtaW4=');
                        done();
                    });
                });

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ContentInfo', './Node', './PathInfo', './PermissionsInfo', './UserInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContentInfo'), require('./Node'), require('./PathInfo'), require('./PermissionsInfo'), require('./UserInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.AlfrescoCoreRestApi) {
      root.AlfrescoCoreRestApi = {};
    }
    root.AlfrescoCoreRestApi.DeletedNode = factory(root.AlfrescoCoreRestApi.ApiClient, root.AlfrescoCoreRestApi.ContentInfo, root.AlfrescoCoreRestApi.Node, root.AlfrescoCoreRestApi.PathInfo, root.AlfrescoCoreRestApi.PermissionsInfo, root.AlfrescoCoreRestApi.UserInfo);
  }
}(this, function(ApiClient, ContentInfo, Node, PathInfo, PermissionsInfo, UserInfo) {
  'use strict';
   ...
   * @param archivedByUser {module:model/UserInfo}
   * @param archivedAt {Date}
   */
  var exports = function(id, name, nodeType, isFolder, isFile, modifiedAt, modifiedByUser, createdAt, createdByUser, archivedByUser, archivedAt) {
    var _this = this;

    Node.call(_this, id, name, nodeType, isFolder, isFile, modifiedAt, modifiedByUser, createdAt, createdByUser);
    _this['archivedByUser'] = archivedByUser;
    _this['archivedAt'] = archivedAt;
  };

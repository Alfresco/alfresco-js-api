...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Error', '../model/RevertBody', '../model/VersionEntry', '../model/VersionPaging'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Error'), require('../model/RevertBody'), require('../model/VersionEntry'), require('../model/VersionPaging'));
  } else {
    // Browser globals (root is window)
    if (!root.AlfrescoCoreRestApi) {
      root.AlfrescoCoreRestApi = {};
    }
    root.AlfrescoCoreRestApi.VersionsApi = factory(root.AlfrescoCoreRestApi.ApiClient, root.AlfrescoCoreRestApi.Error, root.AlfrescoCoreRestApi.RevertBody, root.AlfrescoCoreRestApi.VersionEntry, root.AlfrescoCoreRestApi.VersionPaging);
  }
}(this, function(ApiClient, Error, RevertBody, VersionEntry, VersionPaging) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} nodeId The identifier of a node.
     * @param {String} versionId The identifier of a version, ie. version label, within the version history of a node.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/VersionEntry}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/VersionPaging}
     */

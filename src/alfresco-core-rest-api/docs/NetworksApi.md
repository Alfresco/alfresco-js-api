...
# **getNetworkForPerson**
> PersonNetworkEntry getNetworkForPerson(personIdnetworkId, opts)
...
apiInstance.getNetworkForPerson(personIdnetworkId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
apiInstance.listNetworksForPerson(personId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});

...
<a name="copyNode"></a>
# **copyNode**
> NodeEntry copyNode(nodeIdnodeBodyCopy, opts)
...
var nodeBodyCopy = new AlfrescoCoreRestApi.NodeBodyCopy(); // NodeBodyCopy | The targetParentId and, optionally, a new name which should include the file extension.
...
apiInstance.copyNode(nodeIdnodeBodyCopy, opts).then(function(data) {
...
# **createAssocation**
> AssociationEntry createAssocation(nodeId, associationBodyCreate, opts)
...
var associationBodyCreate = new AlfrescoCoreRestApi.AssociationBody(); // AssociationBody | The target node id and assoc type.

var opts = { 
  'fields': ["fields_example"], // [String] | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
};
apiInstance.createAssocation(nodeId, associationBodyCreate, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
<a name="createNode"></a>
# **createNode**
> NodeEntry createNode(nodeId, nodeBodyCreate, opts)
...
var nodeBodyCreate = new AlfrescoCoreRestApi.NodeBodyCreate(); // NodeBodyCreate | The node information to create.
...
apiInstance.createNode(nodeId, nodeBodyCreate, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
> ChildAssociationEntry createSecondaryChildAssocation(nodeId, secondaryChildAssociationBodyCreate, opts)
...
var secondaryChildAssociationBodyCreate = new AlfrescoCoreRestApi.ChildAssociationBody(); // ChildAssociationBody | The child node id and assoc type.

var opts = { 
  'fields': ["fields_example"], // [String] | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
};
apiInstance.createSecondaryChildAssocation(nodeId, secondaryChildAssociationBodyCreate, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **deleteAssocation**
> deleteAssocation(nodeId, targetId, opts)
...
apiInstance.deleteAssocation(nodeId, targetId, opts).then(function() {
...
> deleteSecondaryChildAssocation(nodeId, childId, opts)
...
apiInstance.deleteSecondaryChildAssocation(nodeId, childId, opts).then(function() {
  console.log('API called successfully.');
}, function(error) {
  console.error(error);
});
...
var opts = { 
  'include': ["include_example"] // [String] | Returns additional information about the node. The following optional fields can be requested: * allowableOperations * association * isLink * isLocked * path * permissions 
  'relativePath': "relativePath_example", // String | A path relative to the **nodeId**. If you set this,  information is returned on the node resolved by this path. 
  'fields': ["fields_example"], // [String] | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
};
...
apiInstance.getNodeContent(nodeId, opts).then(function() {
  console.log('API called successfully.');
}, function(error) {
  console.error(error);
});
...
# **listNodeChildren**
> NodeChildAssociationPaging listNodeChildren(nodeId, , opts)
...
apiInstance.listNodeChildren(nodeId, , opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **listParents**
> NodeAssociationPaging listParents(nodeId, opts)
...
apiInstance.listParents(nodeId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
> NodeChildAssociationPaging listSecondaryChildren(nodeId, opts)
...
apiInstance.listSecondaryChildren(nodeId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
> NodeAssociationPaging listSourceAssociations(nodeId, opts)
...
apiInstance.listSourceAssociations(nodeId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
> NodeAssociationPaging listTargetAssociations(nodeId, , opts)
...
apiInstance.listTargetAssociations(nodeId, , opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
var nodeBodyMove = new AlfrescoCoreRestApi.NodeBodyMove(); // NodeBodyMove | The targetParentId and, optionally, a new name which should include the file extension.

var opts = { 
  'include': ["include_example"] // [String] | Returns additional information about the node. The following optional fields can be requested: * allowableOperations * association * isLink * isLocked * path * permissions 
  'fields': ["fields_example"], // [String] | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
};
apiInstance.moveNode(nodeIdnodeBodyMove, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
apiInstance.unlockNode(nodeId, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
<a name="updateNode"></a>
# **updateNode**
> NodeEntry updateNode(nodeIdnodeBodyUpdate, opts)
...
var nodeBodyUpdate = new AlfrescoCoreRestApi.NodeBodyUpdate(); // NodeBodyUpdate | The node information to update.

var opts = { 
  'include': ["include_example"] // [String] | Returns additional information about the node. The following optional fields can be requested: * allowableOperations * association * isLink * isLocked * path * permissions 
  'fields': ["fields_example"], // [String] | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
};
apiInstance.updateNode(nodeIdnodeBodyUpdate, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **updateNodeContent**
> NodeEntry updateNodeContent(nodeIdcontentBodyUpdate, opts)
...
var contentBodyUpdate = "B"; // String | The binary content
...
apiInstance.updateNodeContent(nodeIdcontentBodyUpdate, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});

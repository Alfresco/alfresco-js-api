# AlfrescoCoreRestApi.VersionsApi
...
var apiInstance = new AlfrescoCoreRestApi.VersionsApi();
...
var revertBody = new AlfrescoCoreRestApi.RevertBody(); // RevertBody | Optionally, specify a version comment and whether this should be a major version, or not.

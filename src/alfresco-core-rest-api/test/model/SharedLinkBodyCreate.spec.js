...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoCoreRestApi.SharedLinkBodyCreate();
  });
  ...
  describe('SharedLinkBodyCreate', function() {
    it('should create an instance of SharedLinkBodyCreate', function() {
      // uncomment below and update the code to test SharedLinkBodyCreate
      //var instane = new AlfrescoCoreRestApi.SharedLinkBodyCreate();
      //expect(instance).to.be.a(AlfrescoCoreRestApi.SharedLinkBodyCreate);
    });

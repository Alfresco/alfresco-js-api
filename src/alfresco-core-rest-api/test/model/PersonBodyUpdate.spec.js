...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoCoreRestApi.PersonBodyUpdate();
  });
  ...
  describe('PersonBodyUpdate', function() {
    it('should create an instance of PersonBodyUpdate', function() {
      // uncomment below and update the code to test PersonBodyUpdate
      //var instane = new AlfrescoCoreRestApi.PersonBodyUpdate();
      //expect(instance).to.be.a(AlfrescoCoreRestApi.PersonBodyUpdate);
    });

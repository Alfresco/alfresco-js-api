...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoCoreRestApi.SharedLink();
  });
  ...
  describe('SharedLink', function() {
    it('should create an instance of SharedLink', function() {
      // uncomment below and update the code to test SharedLink
      //var instane = new AlfrescoCoreRestApi.SharedLink();
      //expect(instance).to.be.a(AlfrescoCoreRestApi.SharedLink);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoCoreRestApi.NodeBodyUpdate();
  });
  ...
  describe('NodeBodyUpdate', function() {
    it('should create an instance of NodeBodyUpdate', function() {
      // uncomment below and update the code to test NodeBodyUpdate
      //var instane = new AlfrescoCoreRestApi.NodeBodyUpdate();
      //expect(instance).to.be.a(AlfrescoCoreRestApi.NodeBodyUpdate);
    });

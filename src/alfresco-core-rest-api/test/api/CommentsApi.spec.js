...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoCoreRestApi.CommentsApi();
  });
  ...
  describe('CommentsApi', function() {
    ...
    describe('listComments', function() {
      it('should call listComments successfully', function(done) {
        //uncomment below and update the code to test listComments
        //instance.listComments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

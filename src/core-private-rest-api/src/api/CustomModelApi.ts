...
export class CustomModelApi {
     ...
     * create Custom Model
     */
    createCustomModel = function (status, description, name, namespaceUri, namespacePrefix) {
     ...
     */
    createCustomType = function (modelName, name, parentName, title, description) {
     ...
     * @param {String} description
     */
    createCustomAspect = function (modelName, name, parentName, title, description) {
     ...
     */
    createCustomConstraint = function (modelName, name, type, parameters) {
     ...
     * @param {String} modelName
     */
    activateCustomModel = function (modelName) {
     ...
     * @param {String} modelName
     */
    deactivateCustomModel = function (modelName) {
     ...
     */
    addPropertyToAspect = function (modelName, aspectName, properties) {
     ...
     * @param {Object} properties
     */
    addPropertyToType = function (modelName, typeName, properties) {
     ...
     */
    updateCustomModel = function (modelName, description, namespaceUri, namespacePrefix) {
     ...
     * @param {String} title
     */
    updateCustomType = function (modelName, typeName, description, parentName, title) {
     ...
     * @param {String} title
     */
    updateCustomAspect = function (modelName, aspectName, description, parentName, title) {
     ...
     */
    getCustomModel = function (modelName, queryParamsInput) {
     ...
     * @param {String} modelName
     */
    getAllCustomType = function (modelName) {
     ...
     * @param {Object} queryParams
     */
    getCustomType = function (modelName, typeName, queryParamsInput) {
     ...
     * @param {String} modelName
     */
    getAllCustomAspect = function (modelName) {
     ...
     * @param {Object} queryParams
     */
    getCustomAspect = function (modelName, aspectName, queryParamsInput) {
     ...
     * @param {String} modelName
     */
    getAllCustomConstraints = function (modelName) {
     ...
     * @param {Object} queryParams
     */
    getCustomConstraints = function (modelName, constraintName, queryParamsInput) {
     ...
     * @param {String} modelName
     */
    deleteCustomModel = function (modelName) {
     ...
     * @param {String} typeName
     */
    deleteCustomType = function (modelName, typeName) {

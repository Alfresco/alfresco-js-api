(function(root, factory) {
   ...
   * @module model/ClassificationGuidesEntry
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>ClassificationGuidesEntry</code>.
   * @alias module:model/ClassificationGuidesEntry
   * @class
   * @param entry
   */
   ...
   * @param {module:model/ClassificationGuidesEntry} obj Optional instance to populate.
   * @return {module:model/ClassificationGuidesEntry} The populated <code>ClassificationGuidesEntry</code> instance.
   */
  ...
  /**
   * @member {module:model/ClassificationGuides} entry
   */

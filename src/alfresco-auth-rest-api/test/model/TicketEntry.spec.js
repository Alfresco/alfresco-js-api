...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoAuthRestApi.TicketEntry();
  });
  ...
  describe('TicketEntry', function() {
    it('should create an instance of TicketEntry', function() {
      // uncomment below and update the code to test TicketEntry
      //var instane = new AlfrescoAuthRestApi.TicketEntry();
      //expect(instance).to.be.a(AlfrescoAuthRestApi.TicketEntry);
    });

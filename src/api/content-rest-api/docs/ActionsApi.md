...
**Return type**: [ActionDefinitionEntry](ActionDefinitionEntry.md)
...
**Return type**: [ActionExecResultEntry](ActionExecResultEntry.md)
...
**Return type**: [ActionDefinitionList](ActionDefinitionList.md)

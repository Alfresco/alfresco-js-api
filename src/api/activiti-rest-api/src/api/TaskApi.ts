...
import { TaskActionsApi } from '../../../../api-new/activiti-rest-api/api/taskActions.api';
import { TaskRepresentation } from '../../../../api-new/activiti-rest-api/model/taskRepresentation';
import { AssigneeIdentifierRepresentation } from '../../../../api-new/activiti-rest-api/model/assigneeIdentifierRepresentation';
import { FormIdentifierRepresentation } from '../../../../api-new/activiti-rest-api/model/formIdentifierRepresentation';
...
import { ChecklistsApi } from '../../../../api-new/activiti-rest-api/api/checklists.api';
import { TaskFormsApi } from '../../../../api-new/activiti-rest-api/api/taskForms.api';
import { CompleteFormRepresentation } from '../../../../api-new/activiti-rest-api/model/completeFormRepresentation';
import { TasksApi } from '../../../../api-new/activiti-rest-api/api/tasks.api';
...
import { TaskFilterRequestRepresentation } from '../../../../api-new/activiti-rest-api/model/taskFilterRequestRepresentation';
import { ResultListDataRepresentationTaskRepresentation } from '../../../../api-new/activiti-rest-api/model/resultListDataRepresentationTaskRepresentation';
import { TaskAuditInfoRepresentation } from '../../../../api-new/activiti-rest-api/model/taskAuditInfoRepresentation';
import { ResultListDataRepresentationRelatedContentRepresentation } from '../../../../api-new/activiti-rest-api/model/resultListDataRepresentationRelatedContentRepresentation';
...
import { UserIdentifierRepresentation } from '../../../../api-new/activiti-rest-api/model/userIdentifierRepresentation';
import { TaskQueryRepresentation } from '../../../../api-new/activiti-rest-api/model/taskQueryRepresentation';
import { ChecklistOrderRepresentation } from '../../../../api-new/activiti-rest-api/model/checklistOrderRepresentation';
import { SaveFormRepresentation } from '../../../../api-new/activiti-rest-api/model/saveFormRepresentation';
import { TaskUpdateRepresentation } from '../../../../api-new/activiti-rest-api/model/taskUpdateRepresentation';

...
export const APIS_ACTIVITI = [AboutApi, AccountintegrationApi, AdminendpointsApi, AdmingroupsApi, AdmintenantsApi, AdminusersApi, AppdefinitionsApi, ChecklistsApi, CommentsApi, ContentApi, DatasourcesApi, DecisionauditsApi, DecisiontablesApi, EndpointsApi, FormmodelsApi, GroupsApi, IdmsyncApi, IntegrationalfrescocloudApi, IntegrationalfrescoonpremiseApi, IntegrationboxApi, IntegrationdriveApi, ModelsApi, ModelsbpmnApi, ModelshistoryApi, ProcessdefinitionsApi, ProcessinstancesApi, ProcessinstancevariablesApi, ProcessscopesApi, RuntimeappdefinitionsApi, RuntimeappdeploymentsApi, ScriptfilesApi, SubmittedformsApi, SystempropertiesApi, TaskactionsApi, TaskformsApi, TasksApi, TaskvariablesApi, UserfiltersApi, UserprofileApi, UsersApi];

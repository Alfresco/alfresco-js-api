...
var apiInstance = new AlfrescoGovernanceServicesRestApi.RecordsApi()
...
<a name="fileRecord"></a>
# **fileRecord**
> RecordEntry fileRecord(recordId, nodeBodyFile, opts)
...
apiInstance.fileRecord(recordId, nodeBodyFile, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **updateRecord**
> RecordEntry updateRecord(recordId, recordBodyUpdate, opts)
...
apiInstance.updateRecord(recordId, recordBodyUpdate, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});

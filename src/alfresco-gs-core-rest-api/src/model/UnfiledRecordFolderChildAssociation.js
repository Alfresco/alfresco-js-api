...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../../../alfrescoApiClient', './model/ChildAssociationInfo', './model/PathInfo', './model/UnfiledRecordFolderChild', './model/UserInfo'], factory);
   ...
   * @class
   * @implements module:model/UnfiledRecordFolderChild
   * @param id {String}

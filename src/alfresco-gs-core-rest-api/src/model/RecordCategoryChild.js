(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AlfrescoGovernanceServicesRestApi.RecordCategoryChild = factory(root.AlfrescoGovernanceServicesRestApi.ApiClient, root.AlfrescoGovernanceServicesRestApi.PathInfo, root.AlfrescoGovernanceServicesRestApi.UserInfo);
  }
   ...
   * @module model/RecordCategoryChild
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>RecordCategoryChild</code>.
   * @alias module:model/RecordCategoryChild
   * @class
   * @param id
   * @param parentId
   * @param name
   ...
   * @param {module:model/RecordCategoryChild} obj Optional instance to populate.
   * @return {module:model/RecordCategoryChild} The populated <code>RecordCategoryChild</code> instance.
   */

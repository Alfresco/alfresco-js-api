(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AlfrescoGovernanceServicesRestApi.RecordFolder = factory(root.AlfrescoGovernanceServicesRestApi.ApiClient, root.AlfrescoGovernanceServicesRestApi.PathInfo, root.AlfrescoGovernanceServicesRestApi.UserInfo);
  }
   ...
   * @module model/RecordFolder
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>RecordFolder</code>.
   * @alias module:model/RecordFolder
   * @class
   * @param id
   * @param parentId
   * @param name
   ...
   * @param {module:model/RecordFolder} obj Optional instance to populate.
   * @return {module:model/RecordFolder} The populated <code>RecordFolder</code> instance.
   */

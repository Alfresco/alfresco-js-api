(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AlfrescoGovernanceServicesRestApi.UnfiledContainerChild = factory(root.AlfrescoGovernanceServicesRestApi.ApiClient, root.AlfrescoGovernanceServicesRestApi.PathInfo, root.AlfrescoGovernanceServicesRestApi.UserInfo);
  }
   ...
   * @module model/UnfiledContainerChild
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>UnfiledContainerChild</code>.
   * @alias module:model/UnfiledContainerChild
   * @class
   * @param id
   * @param parentId
   * @param name
   ...
   * @param {module:model/UnfiledContainerChild} obj Optional instance to populate.
   * @return {module:model/UnfiledContainerChild} The populated <code>UnfiledContainerChild</code> instance.
   */

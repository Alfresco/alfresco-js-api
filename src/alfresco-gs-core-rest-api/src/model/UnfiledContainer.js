(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AlfrescoGovernanceServicesRestApi.UnfiledContainer = factory(root.AlfrescoGovernanceServicesRestApi.ApiClient, root.AlfrescoGovernanceServicesRestApi.PathInfo, root.AlfrescoGovernanceServicesRestApi.UserInfo);
  }
   ...
   * @module model/UnfiledContainer
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>UnfiledContainer</code>.
   * @alias module:model/UnfiledContainer
   * @class
   * @param id
   * @param parentId
   * @param name
   ...
   * @param {module:model/UnfiledContainer} obj Optional instance to populate.
   * @return {module:model/UnfiledContainer} The populated <code>UnfiledContainer</code> instance.
   */

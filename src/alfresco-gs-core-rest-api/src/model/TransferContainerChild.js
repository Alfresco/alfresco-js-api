(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AlfrescoGovernanceServicesRestApi.TransferContainerChild = factory(root.AlfrescoGovernanceServicesRestApi.ApiClient, root.AlfrescoGovernanceServicesRestApi.UserInfo);
  }
   ...
   * @module model/TransferContainerChild
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>TransferContainerChild</code>.
   * @alias module:model/TransferContainerChild
   * @class
   * @param id
   * @param parentId
   * @param name
   ...
   * @param {module:model/TransferContainerChild} obj Optional instance to populate.
   * @return {module:model/TransferContainerChild} The populated <code>TransferContainerChild</code> instance.
   */

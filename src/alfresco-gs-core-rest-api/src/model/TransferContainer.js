(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AlfrescoGovernanceServicesRestApi.TransferContainer = factory(root.AlfrescoGovernanceServicesRestApi.ApiClient, root.AlfrescoGovernanceServicesRestApi.UserInfo);
  }
   ...
   * @module model/TransferContainer
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>TransferContainer</code>.
   * @alias module:model/TransferContainer
   * @class
   * @param id
   * @param parentId
   * @param name
   ...
   * @param {module:model/TransferContainer} obj Optional instance to populate.
   * @return {module:model/TransferContainer} The populated <code>TransferContainer</code> instance.
   */

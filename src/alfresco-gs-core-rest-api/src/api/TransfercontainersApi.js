...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransferContainerEntry} and HTTP response
     */
    this.getTransferContainerWithHttpInfo = function(transferContainerId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Array.<String>} opts.include Returns additional information about the transfer container. Any optional field from the response model can be requested. For example: * allowableOperations * path
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransferContainerEntry}
     */
    this.getTransferContainer = function(transferContainerId, opts) {
      return this.getTransferContainerWithHttpInfo(transferContainerId, opts)
     ...
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransferContainerAssociationPaging} and HTTP response
     */
    this.listTransfersWithHttpInfo = function(transferContainerId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Boolean} opts.includeSource Also include **source** (in addition to **entries**) with folder information on the specified parent **transferContainerId**.
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransferContainerAssociationPaging}
     */
    this.listTransfers = function(transferContainerId, opts) {
      return this.listTransfersWithHttpInfo(transferContainerId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransferContainerEntry} and HTTP response
     */
    this.updateTransferContainerWithHttpInfo = function(transferContainerId, nodeBodyUpdate, opts) {
      opts = opts || {};
    ...
    this.updateTransferContainer = function(transferContainerId, nodeBodyUpdate, opts) {
      return this.updateTransferContainerWithHttpInfo(transferContainerId, nodeBodyUpdate, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

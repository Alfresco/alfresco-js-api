...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UnfiledContainerAssociationPaging} and HTTP response
     */
    this.createUnfiledContainerChildrenWithHttpInfo = function(unfiledContainerId, nodeBodyCreate, opts) {
      opts = opts || {};
     ...
     * @param {Array.<String>} opts.include Returns additional information about the unfiled records container&#39;s children. Any optional field from the response model can be requested. For example: * allowableOperations * path
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UnfiledContainerAssociationPaging}
     */
    this.createUnfiledContainerChildren = function(unfiledContainerId, nodeBodyCreate, opts) {
      return this.createUnfiledContainerChildrenWithHttpInfo(unfiledContainerId, nodeBodyCreate, opts)
     ...
     * @param {Array.<String>} opts.include Returns additional information about the unfiled records container&#39;s children. Any optional field from the response model can be requested. For example: * allowableOperations * path
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UnfiledContainerEntry} and HTTP response
     */
    this.getUnfiledContainerWithHttpInfo = function(unfiledContainerId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Array.<String>} opts.include Returns additional information about the unfiled records container&#39;s children. Any optional field from the response model can be requested. For example: * allowableOperations * path
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UnfiledContainerEntry}
     */
    this.getUnfiledContainer = function(unfiledContainerId, opts) {
      return this.getUnfiledContainerWithHttpInfo(unfiledContainerId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UnfiledContainerAssociationPaging} and HTTP response
     */
    this.listUnfiledContainerChildrenWithHttpInfo = function(unfiledContainerId, opts) {
      opts = opts || {};
      var postBody = null;
    ...
    this.listUnfiledContainerChildren = function(unfiledContainerId, opts) {
      return this.listUnfiledContainerChildrenWithHttpInfo(unfiledContainerId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UnfiledContainerEntry} and HTTP response
     */
    this.updateUnfiledContainerWithHttpInfo = function(unfiledContainerId, unfiledContainerBodyUpdate, opts) {
      opts = opts || {};
    ...
    this.updateUnfiledContainer = function(unfiledContainerId, unfiledContainerBodyUpdate, opts) {
      return this.updateUnfiledContainerWithHttpInfo(unfiledContainerId, unfiledContainerBodyUpdate, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

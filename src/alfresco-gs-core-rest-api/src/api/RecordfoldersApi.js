...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/RMNodeBodyCreate} recordBodyCreate The record information to create.  This field is ignored for multipart/form-data content uploads.
     ...
     */
    this.createRecordFolderChildWithHttpInfo = function(recordFolderId, recordBodyCreate, opts) {
      opts = opts || {};
    ...
    this.createRecordFolderChild = function(recordFolderId, recordBodyCreate, opts) {
      return this.createRecordFolderChildWithHttpInfo(recordFolderId, recordBodyCreate, opts)
     ...
     */
    this.deleteRecordFolderWithHttpInfo = function(recordFolderId) {
      var postBody = null;
    ...
    this.deleteRecordFolder = function(recordFolderId) {
      return this.deleteRecordFolderWithHttpInfo(recordFolderId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/RecordFolderEntry} and HTTP response
     */
    this.getRecordFolderWithHttpInfo = function(recordFolderId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Array.<String>} opts.include Returns additional information about the record folders. Any optional field from the response model can be requested. For example: * allowableOperations * isClosed * path
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/RecordFolderEntry}
     */
    this.getRecordFolder = function(recordFolderId, opts) {
      return this.getRecordFolderWithHttpInfo(recordFolderId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/RecordFolderAssociationPaging} and HTTP response
     */
    this.listRecordFolderChildrenWithHttpInfo = function(recordFolderId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Boolean} opts.includeSource Also include **source** (in addition to **entries**) with record information on the parent folder – the specified parent **recordFolderId**
     * @param {Array.<String>} opts.fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/RecordFolderAssociationPaging}
     */
    this.listRecordFolderChildren = function(recordFolderId, opts) {
      return this.listRecordFolderChildrenWithHttpInfo(recordFolderId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/RecordFolderEntry} and HTTP response
     */
    this.updateRecordFolderWithHttpInfo = function(recordFolderId, recordFolderBodyUpdate, opts) {
      opts = opts || {};
    ...
    this.updateRecordFolder = function(recordFolderId, recordFolderBodyUpdate, opts) {
      return this.updateRecordFolderWithHttpInfo(recordFolderId, recordFolderBodyUpdate, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

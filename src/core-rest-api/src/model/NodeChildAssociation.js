(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../../../alfrescoApiClient', './ChildAssociationInfo', './ContentInfo', './Node', './PathInfo', './PermissionsInfo', './UserInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../../../alfrescoApiClient'), require('./ChildAssociationInfo'), require('./ContentInfo'), require('./Node'), require('./PathInfo'), require('./PermissionsInfo'), require('./UserInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.AlfrescoCoreRestApi) {
      root.AlfrescoCoreRestApi = {};
    }
    root.AlfrescoCoreRestApi.NodeChildAssociation = factory(root.AlfrescoCoreRestApi.ApiClient, root.AlfrescoCoreRestApi.ChildAssociationInfo, root.AlfrescoCoreRestApi.ContentInfo, root.AlfrescoCoreRestApi.Node, root.AlfrescoCoreRestApi.PathInfo, root.AlfrescoCoreRestApi.PermissionsInfo, root.AlfrescoCoreRestApi.UserInfo);
  }
}(this, function(ApiClient, ChildAssociationInfo, ContentInfo, Node, PathInfo, PermissionsInfo, UserInfo) {
  'use strict';

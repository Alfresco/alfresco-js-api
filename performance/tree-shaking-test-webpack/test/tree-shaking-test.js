...
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var superagent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
var AlfrescoApiClient = (function () {
    ...
    AlfrescoApiClient.prototype.applyAuthToRequest = function (request) {
        var _this = this;
        var auth = _this.authentications.basicAuth;
        switch (auth.type) {
            case 'basic':
    ...
    AlfrescoApiClient.prototype.parseDate = function (dateToConvert) {
        var dateLength = 10;
    ...
    AlfrescoApiClient.prototype.parseDateTime = function (dateToConvert) {
    ...
    AlfrescoApiClient.prototype.parseDateTimeZone = function (dateToConvert) {
    ...
    AlfrescoApiClient.prototype.convertToType = function (data, type) {
        var _this_1 = this;
        switch (type) {
            case 'Binary':
                return data;
            ...
            default:
                if (type === Object) {
                    ...
                    var itemType_1 = type[0];
                    if (data) {
                        return data.map(function (item) {
                            return _this_1.convertToType(item, itemType_1);
                        });
                    }
                    else {
                        return null;
                    ...
                    var keyType = void 0, valueType = void 0;
                    for (var k in type) {
            ...
            request.end(function (error, response) {
                if (error) {
                    ...
                    if (response.type === 'text/html') {
                        data = _this_1.deserialize(response, 'String');
                    }
                    else {
...
var event_emitter = __webpack_require__(1);

// EXTERNAL MODULE: /Users/eromano/Projects/dev-platform-js-api/node_modules/tslib/tslib.es6.js
...
var authentication_api_AuthenticationApi = (function (_super) {
    tslib_es6["a" /* __extends */](AuthenticationApi, _super);
    ...
    AuthenticationApi.prototype.createTicket = function (ticketBodyCreate) {
        ...
        return this.apiClient.callApi('/tickets', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts);
    };
    ...
    AuthenticationApi.prototype.validateTicket = function () {
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/tickets/-me-', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts);
    };
...
var alfrescoApiClient = __webpack_require__(2);

// CONCATENATED MODULE: /Users/eromano/Projects/dev-platform-js-api/node_modules/alfresco-js-api/_esm5/src/ecmAuth.js
/*!
 * @license
 * Copyright 2018 Alfresco Software, Ltd.
 *
...
var ecmAuth_Emitter = event_emitter;
var ecmAuth_EcmAuth = (function (_super) {
    tslib_es6["a" /* __extends */](EcmAuth, _super);
    function EcmAuth(config) {
        ...
        ecmAuth_Emitter.call(_this);
        return _this;
    }
    EcmAuth.prototype.changeHost = function () {
        this.basePath = this.config.hostEcm + '/' + this.config.contextRoot + '/api/-default-/public/authentication/versions/1';
        this.ticket = undefined;
    };
    EcmAuth.prototype.saveUsername = function (username) {
        if (this.storage.supportsStorage()) {
            this.storage.setItem('ACS_USERNAME', username);
        }
    };
    EcmAuth.prototype.login = function (username, password) {
        var _this = this;
        this.authentications.basicAuth.username = username;
        this.authentications.basicAuth.password = password;
        var authApi = new authentication_api_AuthenticationApi(this);
        var loginRequest;
        ...
        ecmAuth_Emitter(promise);
        return promise;
    };
    EcmAuth.prototype.validateTicket = function () {
        var _this = this;
        var authApi = new authentication_api_AuthenticationApi(this);
    ...
    EcmAuth.prototype.logout = function () {
        var _this = this;
        this.saveUsername('');
        var authApi = new authentication_api_AuthenticationApi(this);
        var promise = new Promise(function (resolve, reject) {
    ...
    EcmAuth.prototype.setTicket = function (ticket) {
    ...
    EcmAuth.prototype.getTicket = function () {
        return this.ticket;
    };
    EcmAuth.prototype.invalidateSession = function () {
        this.storage.removeItem(this.ticketStorageLabel);
        this.authentications.basicAuth.username = null;
        this.authentications.basicAuth.password = null;
        this.ticket = null;
    };
    EcmAuth.prototype.isLoggedIn = function () {
        return !!this.ticket;
    };
    EcmAuth.prototype.getAuthentication = function () {
        return this.authentications;
    };
    return EcmAuth;
}(alfrescoApiClient["a" /* AlfrescoApiClient */]));

ecmAuth_Emitter(ecmAuth_EcmAuth.prototype);
//# sourceMappingURL=ecmAuth.js.map
// EXTERNAL MODULE: /Users/eromano/Projects/dev-platform-js-api/node_modules/alfresco-js-api/_esm5/src/bpmAuth.js
var bpmAuth = __webpack_require__(33);

// EXTERNAL MODULE: /Users/eromano/Projects/dev-platform-js-api/node_modules/alfresco-js-api/_esm5/src/oauth2Auth.js
var oauth2Auth = __webpack_require__(34);

// CONCATENATED MODULE: /Users/eromano/Projects/dev-platform-js-api/node_modules/alfresco-js-api/_esm5/src/ecmClient.js
/*!
 * @license
 * Copyright 2018 Alfresco Software, Ltd.
 *
...
var ecmClient_EcmClient = (function (_super) {
    tslib_es6["a" /* __extends */](EcmClient, _super);
    function EcmClient(config, servicePath) {
        var _this = _super.call(this) || this;
        _this.className = 'EcmClient';
        _this.config = config;
        _this.servicePath = servicePath;
        _this.changeHost();
        return _this;
    }
    EcmClient.prototype.changeHost = function () {
        this.host = this.config.hostEcm;
        this.basePath = this.config.hostEcm + '/' + this.config.contextRoot + this.servicePath;
    };
    EcmClient.prototype.setAuthentications = function (authentications) {
        this.authentications = authentications;
    };
    return EcmClient;
}(alfrescoApiClient["a" /* AlfrescoApiClient */]));

//# sourceMappingURL=ecmClient.js.map
// CONCATENATED MODULE: /Users/eromano/Projects/dev-platform-js-api/node_modules/alfresco-js-api/_esm5/src/bpmClient.js
/*!
 * @license
 * Copyright 2018 Alfresco Software, Ltd.
 *
...
var bpmClient_BpmClient = (function (_super) {
    tslib_es6["a" /* __extends */](BpmClient, _super);
    ...
    BpmClient.prototype.changeHost = function () {
        this.host = this.config.hostBpm;
        this.basePath = this.config.hostBpm + '/' + this.config.contextRootBpm;
    };
    BpmClient.prototype.setAuthentications = function (authentications) {
        this.authentications = authentications;
    };
    return BpmClient;
}(alfrescoApiClient["a" /* AlfrescoApiClient */]));

//# sourceMappingURL=bpmClient.js.map
...
var alfrescoApi_AlfrescoApi = (function () {
    ...
    AlfrescoApi.prototype.setConfig = function (config) {
        ...
        this.ecmPrivateClient = new ecmClient_EcmClient(this.config, '/api/-default-/private/alfresco/versions/1');
        this.ecmClient = new ecmClient_EcmClient(this.config, '/api/-default-/public/alfresco/versions/1');
        this.searchClient = new ecmClient_EcmClient(this.config, '/api/-default-/public/search/versions/1');
        this.discoveryClient = new ecmClient_EcmClient(this.config, '/api');
        this.gsClient = new ecmClient_EcmClient(this.config, '/api/-default-/public/gs/versions/1');
        this.bpmClient = new bpmClient_BpmClient(this.config);
        this.errorListeners();
        if (this.isOauthConfiguration()) {
            this.oauth2Auth = new oauth2Auth["a" /* Oauth2Auth */](this.config);
            this.setAuthenticationClientECMBPM(this.oauth2Auth.getAuthentication(), this.oauth2Auth.getAuthentication());
        }
        else {
            this.bpmAuth = new bpmAuth["a" /* BpmAuth */](this.config);
            this.ecmAuth = new ecmAuth_EcmAuth(this.config);
        ...
        if (this.isOauthConfiguration()) {
            ...
            if (this.isBpmConfiguration()) {
                ...
                ecmPromise.then(function (ticketEcm) {
                    _this.setAuthenticationClientECMBPM(_this.ecmAuth.getAuthentication(), null);
...
var discovery_api_DiscoveryApi = (function (_super) {
    tslib_es6["a" /* __extends */](DiscoveryApi, _super);
    ...
    DiscoveryApi.prototype.getRepositoryInformation = function () {
        ...
        var contentTypes = [];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/discovery', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts);
    };
    return DiscoveryApi;
}(base_api_BaseApi));
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BpmAuth; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var event_emitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
...
/* harmony import */ var _alfrescoApiClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/*!
 * @license
 * Copyright 2018 Alfresco Software, Ltd.
 *
...
var Emitter = event_emitter__WEBPACK_IMPORTED_MODULE_1__;
var BpmAuth = (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__[/* __extends */ "a"](BpmAuth, _super);
    ...
    BpmAuth.prototype.changeHost = function () {
        this.basePath = this.config.hostBpm + '/' + this.config.contextRootBpm;
        this.ticket = undefined;
    };
    BpmAuth.prototype.changeCsrfConfig = function (disableCsrf) {
        this.config.disableCsrf = disableCsrf;
    };
    BpmAuth.prototype.saveUsername = function (username) {
        if (this.storage.supportsStorage()) {
            this.storage.setItem('APS_USERNAME', username);
        }
    };
    BpmAuth.prototype.login = function (username, password) {
        var _this = this;
        this.authentications.basicAuth.username = username;
        this.authentications.basicAuth.password = password;
        ...
        var promise = new Promise(function (resolve, reject) {
            _this.callApi('/app/authentication', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts).then(function (data) {
                _this.saveUsername(username);
                var ticket = 'Basic ' + new Buffer(_this.authentications.basicAuth.username + ':' + _this.authentications.basicAuth.password).toString('base64');
    ...
    BpmAuth.prototype.logout = function () {
        var _this = this;
        this.saveUsername('');
    ...
    BpmAuth.prototype.setTicket = function (ticket) {
        this.authentications.basicAuth.ticket = ticket;
        this.authentications.basicAuth.password = null;
        this.storage.setItem('ticket-BPM', ticket);
        this.ticket = ticket;
    };
    BpmAuth.prototype.invalidateSession = function () {
        this.storage.removeItem('ticket-BPM');
        this.authentications.basicAuth.ticket = null;
        this.authentications.basicAuth.password = null;
        this.ticket = null;
    };
    BpmAuth.prototype.getTicket = function () {
        return this.ticket;
    };
    BpmAuth.prototype.isLoggedIn = function () {
        return !!this.ticket;
    };
    BpmAuth.prototype.getAuthentication = function () {
        return this.authentications;
    };
    return BpmAuth;
}(_alfrescoApiClient__WEBPACK_IMPORTED_MODULE_2__[/* AlfrescoApiClient */ "a"]));

Emitter(BpmAuth.prototype);
//# sourceMappingURL=bpmAuth.js.map
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(3).Buffer))
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Oauth2Auth; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var event_emitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var event_emitter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(event_emitter__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _alfrescoApiClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
...
var Oauth2Auth = (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__[/* __extends */ "a"](Oauth2Auth, _super);
    function Oauth2Auth(config) {
        ...
        if (_this.config.oauth2) {
            ...
            if (!_this.config.oauth2.redirectSilentIframeUri) {
                ...
                _this.config.oauth2.redirectSilentIframeUri = context_1 + '/assets/silent-refresh.html';
            }

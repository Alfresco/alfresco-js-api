...
JSON
{
  \"list\": {
    ...
    * @param include Returns additional information about the shared link, the following optional fields can be requested:
* allowableOperations
* path
...
parameter are returned in addition to those specified in the **fields** parameter.
    ...
    **Note:** The list of links is eventually consistent so newly created shared links may not appear immediately.
    ...
    If not supplied then the default value is 100.
        ...
        * @param where Optionally filter the list by \"sharedByUser\" userid of person who shared the link (can also use -me-)

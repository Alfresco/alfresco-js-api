...
parameter are returned in addition to those specified in the **fields** parameter.
    ...
    **Note:** You can create more than one association by
    ...
    createAssocation(nodeId: string, associationBodyCreate: AssociationBody, opts: any): Promise<AssociationEntry> {
        ...
        if (nodeId === undefined || nodeId === null) {
            throw new Error("Required param 'nodeId' in createAssocation");
        }

        if (associationBodyCreate === undefined || associationBodyCreate === null) {
            throw new Error("Required param 'associationBodyCreate' in createAssocation");
        }
    ...
    **Note:** You can create more than one secondary child association by
    ...
    createSecondaryChildAssocation(nodeId: string, secondaryChildAssociationBodyCreate: ChildAssociationBody, opts: any): Promise<ChildAssociationEntry> {
        ...
        if (nodeId === undefined || nodeId === null) {
            throw new Error("Required param 'nodeId' in createSecondaryChildAssocation");
        }

        if (secondaryChildAssociationBodyCreate === undefined || secondaryChildAssociationBodyCreate === null) {
            throw new Error("Required param 'secondaryChildAssociationBodyCreate' in createSecondaryChildAssocation");
        }
    ...
    **Note:** After removal of the peer association, or associations, from source to target, the two nodes may still have peer associations
    ...
    deleteAssocation(nodeId: string, targetId: string, opts: any): Promise<{}> {
        ...
        if (nodeId === undefined || nodeId === null) {
            throw new Error("Required param 'nodeId' in deleteAssocation");
        }

        if (targetId === undefined || targetId === null) {
            throw new Error("Required param 'targetId' in deleteAssocation");
        }
    ...
    **Note:** If the node is not permanently deleted, and is later successfully restored to its former primary parent, then the primary
    ...
    associations were to nodes inside or outside the restored hierarchy.
        ...
        * @param nodeId The identifier of a node.
        * @param permanent If **true** then the node is deleted permanently, without moving to the trashcan.
    ...
    deleteSecondaryChildAssocation(nodeId: string, childId: string, opts: any): Promise<{}> {
        ...
        if (nodeId === undefined || nodeId === null) {
            throw new Error("Required param 'nodeId' in deleteSecondaryChildAssocation");
        }

        if (childId === undefined || childId === null) {
            throw new Error("Required param 'childId' in deleteSecondaryChildAssocation");
        }
    ...
    * permissions
        ...
        * @param relativePath Return information on children in the folder resolved by this path. The path is relative to **nodeId**.
    ...
    * -root-
        ...
        * @param where Optionally filter the list by assocType. Here's an example:
    ...
    **Note:** This API method accepts any content type, but for testing with this tool text based content can be provided.
    ...
    tooling to accept an arbitrary file.
        ...
        * @param majorVersion If **true**, create a major version.
    Setting this parameter also enables versioning of this node, if it is not already versioned.
    
        * @param comment Add a version comment which will appear in version history.
    Setting this parameter also enables versioning of this node, if it is not already versioned.
    
        * @param name Optional new name. This should include the file extension.

...
export class SitesApi extends BaseApi {
    ...
    * @param siteMembershipApprovalBody Accepting a request to join, optionally, allows assignment of a role to the user.
    ...
    **Note:** if skipped then such a site will **not** work within Share.
    ...
    This container is the root folder for content stored in the site.
        ...
        * @param skipConfiguration Flag to indicate whether the Share-specific (surf) configuration files for the site should not be created.
        * @param skipAddToFavorites Flag to indicate whether the site should not be added to the user's site favorites.
    ...
    * description
    ...
    /**
        ...
        * @param siteId The identifier of a site.
        * @param inviteeId The invitee user name.
        * @param siteMembershipRejectionBody Rejecting a request to join, optionally, allows the inclusion of comment.

...
**allowableOperations** | **any** | The allowable operations for the Quickshare link itself. See allowableOperationsOnTarget for the
allowable operations pertaining to the linked content node.
 | [optional] [default to null]
**allowableOperationsOnTarget** | **any** | The allowable operations for the content node being shared.
 | [optional] [default to null]

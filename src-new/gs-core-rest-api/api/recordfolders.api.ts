...
This field is ignored for multipart/form-data content uploads.
    ...
    * @param include Returns additional information about the record. Any optional field from the response model can be requested. For example:
* allowableOperations
* content
* isCompleted
* path
...
parameter are returned in addition to those specified in the **fields** parameter.
    ...
    */
    ...
    You can use the **include** parameter (include=allowableOperations) to return additional information.
        ...
        * @param recordFolderId The identifier of a record folder.
        * @param include Returns additional information about the record folders. Any optional field from the response model can be requested. For example:
    * allowableOperations
    * isClosed
    * path
    ...
    *   where=(isPrimary=true)
        ...
        * @param include Returns additional information about the records. Any optional field from the response model can be requested. For example:
    * allowableOperations
    * aspectNames
    * association
    * content
    ...
    * properties
        ...
        * @param includeSource Also include **source** (in addition to **entries**) with record information on the parent folder – the specified parent **recordFolderId**
        * @param fields A list of field names.

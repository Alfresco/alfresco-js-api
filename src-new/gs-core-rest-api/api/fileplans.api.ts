...
parameter are returned in addition to those specified in the **fields** parameter.
    ...
    */
    ...
    You can use the **include** parameter (include=allowableOperations) to return additional information.
        ...
        * @param filePlanId The identifier of a file plan. You can also use the -filePlan- alias.
        * @param include Returns additional information about the file plan. Any optional field from the response model can be requested. For example:
    * allowableOperations
    * path
    ...
    * properties
        ...
        * @param includeSource Also include **source** (in addition to **entries**) with folder information on the parent node – the specified parent **filePlanId**
        * @param fields A list of field names.

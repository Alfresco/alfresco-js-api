...
describe('Alfresco Content', function () {
    ...
    it('get Document Thumbnail Url', function () {
        ...
        expect(thumbnailUrl).to.be.equal('http://127.0.0.1:8080/alfresco/api/-default-/public/alfresco/versions/1/nodes/' +
    ...
    it('get Content Url', function () {
        ...
        expect(contentUrl).to.be.equal('http://127.0.0.1:8080/alfresco/api/-default-/public/alfresco/versions/1/nodes/' +

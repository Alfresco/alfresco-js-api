...
export class NodeMock extends BaseMock {
    ...
    get200ResponseSingleFileFolder(): void {
        nock(this.host, { encodedQueryParams: true })
    ...
    get404DeletePermanentlyNotFound(): void {
        nock(this.host, { encodedQueryParams: true })
    ...
    get409CreationFolderNewNameClashes(): void {
        nock(this.host, { encodedQueryParams: true })
            .post('/alfresco/api/-default-/public/alfresco/versions/1/nodes/-root-/children', {
                name: 'newFolder',
                nodeType: 'cm:folder',
    ...
    get201CreationFolderNewNameNotClashes(): void {
        nock(this.host, { encodedQueryParams: true })
            .post('/alfresco/api/-default-/public/alfresco/versions/1/nodes/-root-/children', {
                name: 'newFolder',
                nodeType: 'cm:folder',
